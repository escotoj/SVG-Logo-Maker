...
class shapes {
    ...
    setShapeColor (colorChoice) {
        this.setShapeColor = colorChoice;
    }
    setTextColor (shapeText) {
        this.setTextColor = shapeText;
    }
}
...
class Square extends shapes {
    render() {
    return `<rect="150, 18 244, 182 56, 182" fill="${this.shapeColor}"/>`;
    }
}
...
// theShape.setShapeColor(shapeColor);
